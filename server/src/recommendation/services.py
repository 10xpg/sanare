...
from recommendation.models import DbDiagnosis, DbPatient, DbReport, DbVitals
from recommendation.schemas import PatientBase, DiagnosisBase, ReportBase, VitalsBase

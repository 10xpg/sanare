        ...
        <fieldset>
          ...
          <div className='flex gap-16 items-center py-3 pb-6'>
            ...
            <label className='flex-1'>
              Relationship
              <br />
              <input type='text' required className='w-10/12 h-10 rounded placeholder-[#999EA4] text-black p-3 outline-black' />
            </label>
            <label className='flex-1'>
              Phone Number
              <br />
              <input type='tel' required className='w-10/12 h-10 rounded placeholder-[#999EA4] text-black p-3 outline-black' />
            </label>
          </div>
